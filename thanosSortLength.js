...
// Otherwise, he destroys half of the elements.
...
function thanosSort(arr) {
  const canRestInAGratefulWorld = arr.every((item, idx) => idx === 0 || arr[idx - 1] <= item);  
  if (canRestInAGratefulWorld) return arr.length;
